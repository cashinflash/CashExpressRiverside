...
1. Open the repo's `fonts/` folder on the `claude/local-sites-shared-database-fOnrh` branch.
...
```bash
git clone -b claude/local-sites-shared-database-fOnrh \
  git@github.com:cashinflash/CashExpressRiverside.git
cd CashExpressRiverside
