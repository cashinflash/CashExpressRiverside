 ...
 * All events fire into the same [[GA4_ID]] property.
 *
 * Events emitted:
 *   - apply_click     : User clicks any "Apply Now" button or apply.cashexpressriverside.com link
 ...
 *   - outbound_click  : Click on an external link (non-cashexpressriverside.com domain)
 */
(function () {
  'use strict';
  ...
  document.addEventListener('click', function (e) {
    ...
    // Apply Now click — covers .btn-apply, .btn-apply-lg, and any link to apply.cashexpressriverside.com
    var isApplyBtn = /\bbtn-apply\b/.test(cls);
    var isApplyLink = href.indexOf('apply.cashexpressriverside.com') !== -1;
    ...
    // Outbound link tracking (any external non-cashexpressriverside domain)
    if (/^https?:\/\//i.test(href)) {
      try {
        var u = new URL(href);
        if (u.hostname.indexOf('cashexpressriverside.com') === -1) {
